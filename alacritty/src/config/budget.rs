...
//! commitment-device design (3 h cap, 02:00–06:00 sleep window in Chicago
...
//! sleep_end_hour = 6            # 06:00 local — unlock
...
pub struct BudgetConfig {
    ...
    /// Hour of day (0–23) at which the sleep-window block engages AND the
    /// daily counter resets. Same hour, two effects.

...
use crate::event::{
    ActionContext, Event, EventProxy, InlineSearchState, Mouse, RenameTabState, SearchState,
    TouchPurpose,
};
#[cfg(unix)]
...
pub struct WindowContext {
    ...
    rename_tab_state: RenameTabState,
    notifier: Notifier,
    mouse: Mouse,
    touch: TouchPurpose,
    occluded: bool,
...
impl WindowContext {
    ...
    fn new(
        ...
        Ok(WindowContext {
            ...
            rename_tab_state: Default::default(),
    ...
    pub fn handle_event(
        ...
        let context = ActionContext {
            ...
            rename_tab_state: &mut self.rename_tab_state,

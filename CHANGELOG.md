...
- macOS fork: Restore cglm conversations through GLM instead of Claude subscription credits
- macOS fork: Preserve Codex tab conversations after an npm update removes the running binary
